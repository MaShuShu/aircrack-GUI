...
public class SysCommandExecutor {
	...
	public int runSyncCommand(String commandLine) throws Exception {
		/* run command */
		fCmdError = null;
		fCmdOutput = null;
	...
	public int runSyncCommand(String commandLine, int timeout_sec) throws Exception {
		fCmdError = null;
		fCmdOutput = null;
		int res = -1;
		runAsyncCommand(commandLine);

		for (int n = 0; n < timeout_sec * 4; n++) {
	...
	public void runAsyncCommand(String commandLine) throws Exception {
		/* run command */
		fCmdError = null;
		fCmdOutput = null;
		process = runCommandHelper(commandLine);
